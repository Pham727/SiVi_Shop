...
import cat2Img from "assets/users/images/categories/cat_3.jpg"
import cat3Img from "assets/users/images/categories/cat_1.jpg"
    ...
    return ( 
        <>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 product_detail_pic">
                    ...
                    <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 product_detail_text">
                        <h2>Rau củ xanh</h2>
                        ...
                        <p>
                            Cải xanh, hay còn gọi là cải bẹ xanh, là một loại rau xanh quen thuộc trong ẩm thực Việt Nam. 
                            Cải xanh không chỉ dễ trồng mà còn rất giàu dinh dưỡng. Loại rau này cung cấp nhiều 
                            vitamin A, C, K và khoáng chất như canxi, sắt. 
                        </p>
                        <Quantity />
                        <ul>
                            <li>
